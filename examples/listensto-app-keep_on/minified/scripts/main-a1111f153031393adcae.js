...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    render: function render() {
	        ...
	        document.querySelector("#" + containerSelector).innerHTML = (0, _template2.default)(placeholders);
	
	        setTimeout(function () {
	            _this.publish('INIT_CONTENT_MODULE');
	        }, 3000);
	
	        document.querySelector("#emitter").addEventListener("click", function () {
	            _this.publish('ADD_TIMESTAMP', Date());
	        });
	    },
	    config: {}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<h3>Header</h3>\n<button id=\"emitter\">Add timestamp</button>\n<hr>";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _template = __webpack_require__(337);
	...
	exports.default = {
	    data: [],
	    addTimestamp: function addTimestamp(date) {
	        var list = document.querySelector(".timestamp-list");
	
	        if (list) {
	            var html = "";
	            if (this.data.length) {
	                html = this.data.map(function (time) {
	                    return "<li>" + time + "</li>";
	                }).join("");
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _template = __webpack_require__(339);
...
//# sourceMappingURL=main-a1111f153031393adcae.js.map