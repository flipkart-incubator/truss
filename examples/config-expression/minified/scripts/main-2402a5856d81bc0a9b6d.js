...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pubsub = __webpack_require__(125);
	...
	var Module = function () {
		var modulePrivateData = new _weakMap2.default();
	
		var Module = function (_PubSub) {
			(0, _inherits3.default)(Module, _PubSub);
			...
			(0, _createClass3.default)(Module, [{
				...
				value: function render(placeholderData) {
					...
					var clonedPlaceholders = (0, _extends3.default)({}, placeholders);
				...
				value: function subscribe(subscription) {
					...
					(0, _get3.default)((0, _getPrototypeOf2.default)(Module.prototype), "subscribe", this).call(this, subscription, eventName);
				}
			}, {
				key: "publish",
				value: function publish(eventName, message) {
					(0, _get3.default)((0, _getPrototypeOf2.default)(Module.prototype), "publish", this).call(this, eventName, message);
				}
			}, {
				key: "unsubscribe",
				value: function unsubscribe(eventName, callback) {
					(0, _get3.default)((0, _getPrototypeOf2.default)(Module.prototype), "unsubscribe", this).call(this, this.getModuleContainer(), eventName, callback);
				}
			}], [{
				key: "recursiveGetProperty",
				value: function (_recursiveGetProperty) {
					function recursiveGetProperty(_x, _x2) {
						return _recursiveGetProperty.apply(this, arguments);
					}
	
					recursiveGetProperty.toString = function () {
						return _recursiveGetProperty.toString();
					};
	
					return recursiveGetProperty;
				...
				key: "evalInContext",
				value: function evalInContext(placeholders, context) {
					var self = context;
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(33)(Function.call, __webpack_require__(78).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.eventQ = exports.isServer = exports.moduleS = exports.subscriptions = exports.isBrowser = undefined;
	...
	var moduleS = (0, _extends3.default)([], {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _head = __webpack_require__(151);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _handlebarsSafeString = __webpack_require__(144);
	
	var _handlebarsSafeString2 = _interopRequireDefault(_handlebarsSafeString);
	
	var _handlebarsException = __webpack_require__(132);
	
	var _handlebarsException2 = _interopRequireDefault(_handlebarsException);
	
	var _handlebarsUtils = __webpack_require__(131);
	
	var Utils = _interopRequireWildcard(_handlebarsUtils);
	
	var _handlebarsRuntime = __webpack_require__(145);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _exception = __webpack_require__(132);
	
	var _exception2 = _interopRequireDefault(_exception);
	
	var _helpers = __webpack_require__(133);
	
	var _decorators = __webpack_require__(141);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _helpersBlockHelperMissing = __webpack_require__(134);
	
	var _helpersBlockHelperMissing2 = _interopRequireDefault(_helpersBlockHelperMissing);
	
	var _helpersEach = __webpack_require__(135);
	
	var _helpersEach2 = _interopRequireDefault(_helpersEach);
	
	var _helpersHelperMissing = __webpack_require__(136);
	
	var _helpersHelperMissing2 = _interopRequireDefault(_helpersHelperMissing);
	
	var _helpersIf = __webpack_require__(137);
	...
	var _helpersLookup = __webpack_require__(139);
	
	var _helpersLookup2 = _interopRequireDefault(_helpersLookup);
	
	var _helpersWith = __webpack_require__(140);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _decoratorsInline = __webpack_require__(142);
...
//# sourceMappingURL=main-2402a5856d81bc0a9b6d.js.map